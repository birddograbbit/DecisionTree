...
class SignalEngine:
    ...
    trading signals. Position sizing is based on the distance of a probability
    from 0.5 using a square-root function.
    """
    ...
    def generate_signals(self, predictions, dates, symbol='SPY'):
        ...
        for i, probability in enumerate(predictions):
            ...
            # Calculate position size using square-root weighting (F-5)
