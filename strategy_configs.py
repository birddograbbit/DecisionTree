...
# JFK-DSRSI Strategy (Optimized for 5min SPX)
JFK_DSRSI_CONFIG = {
    'name': 'JFK-DSRSI',
    ...
    # KPS parameters (Optimized)
    'kps_length': 14,  # Keep default
    'kps_smooth_period': 8,
    'kps_long_exit_threshold': 84,
    'kps_short_exit_threshold': 5,
    # PST parameters (Optimized)
    'pst_length': 17,
    'pst_smooth': 6,
    'pst_x': 3,
    'jphase': 78.91,
    # Entry/Exit parameters (Optimized)
    'rsi_long_threshold': 60,  # Keep default
    'rsi_short_threshold': 40,  # Keep default
...
JFK_DSRSI_SPX_CONFIG = {
    **JFK_DSRSI_CONFIG,
    'name': 'JFK-DSRSI SPX (Optimized)',
    'symbol': 'SPX',
    'asset_type': 'INDEX',
    'timeframe': '5min',
    # Override with SPX-specific optimized parameters
    'atr_length': 18,
    'dsrsi_length': 30,
    'exit_at_opposite_signal': True,
    'jphase': 78.91,
